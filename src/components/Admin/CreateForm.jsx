      ...
      <div className="relative w-[600px] max-w-full p-5 bg-white rounded">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
          <div className="flex gap-2 flex-wrap">
            ...
            {selectedImages.length > 0 && <div className="size-8 md:size-10 bg-stone-100 flex items-center justify-center border rounded hover:shadow cursor-pointer">
              <label
          ...
          {selectedImages.length === 0 && <div className="flex items-center justify-center w-full">
            <label
              for="dropzone-file"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 ">
            ...
            />
            <input type="number" min={1} disabled={paymentType.value === 'cash'} onChange={handleInsYears} className="py-2 border p-2 text-sm rounded outline-none col-span-2 sm:col-span-1" placeholder="Installment Years..."/>
          </div>
