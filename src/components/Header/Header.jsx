  ...
  return (
    <div className="bg-white sticky top-0 z-40">
      <div className="flex px-4 rounded-lg max-w-screen-2xl h-14 mx-auto justify-between items-center">
        ...
        {/* <div className="flex gap-10 text-xl items-center cursor-pointer">
        ...
        <div className="flex items-center h-full gap-2">
          <button
            type="button"
            className="text-sm w-20 py-2 rounded-full text-white bg-blue-500"
            onClick={toggleLang}
          >
            {lang === 'en' ? 'AR' : 'EN'}
          </button>
          <button
            type="button"
            className="text-sm w-20 py-2 rounded-full text-black border border-black hidden lg:block"
          >
