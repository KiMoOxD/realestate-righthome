...
export default function CallInfo({ property }) {
  ...
  return (
    <div className="w-full lg:w-[450px] xl:w-[500px] flex flex-col items-center gap-3 text-white bg-blue-500 shadow-md rounded-md p-5 xl:p-10">
    ...
    <div className='mt-5 bg-red w-full flex justify-evenly gap-1 text-white text-xl mb-5'>
      <a href='https://www.facebook.com/profile.php?id=100064228025102' className='flex flex-col gap-1 items-center'><IoLogoFacebook className='text-4xl'/> Facebook</a>
      <a href='https://www.instagram.com/right.homee' className='flex flex-col gap-0.5 items-center'><IoLogoInstagram className='text-4xl'/> Instagram</a>
    </div>
    <a
